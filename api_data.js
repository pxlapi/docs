define({ "api": [
  ...
  {
    "type": "get",
    "url": "/management/logs/:applicationID",
    "title": "List application logs",
    "group": "~Management",
    "description": "<p>Lists the applications recent log entries</p>",
    "parameter": {
      "fields": {
        "Path Arguments": [
          {
            ...
            "optional": false,
            "field": "applicationID",
            "description": "<p>The ID of the application to list logs for (or @ for the currently authorized application)</p>"
          }
        ]
      }
    },
    ...
    "version": "0.0.0",
    "filename": "controllers/management/log/Log.js",
    "groupTitle": "~Management",
    "name": "GetManagementLogsApplicationid",
    "success": {
      "fields": {
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>The log entry's unique ID</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "user_id",
            "description": "<p>The associated users ID</p>"
          },
          {
            "group": "Success 200",
            "type": "string|null",
            ...
            "description": "<p>The associated applications ID</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "controller",
            "description": "<p>The called controller name</p>"
          },
          {
            "group": "Success 200",
            "type": "number",
            "optional": false,
            "field": "status",
            "description": "<p>The HTTP response status</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
          ...
          },
          {
            ...
            "description": "<p>A list of IP addresses involved in this request</p>"
          },
          {
            "group": "Success 200",
            "type": "number",
            "optional": false,
            "field": "time_taken",
            "description": "<p>The time it took to process the request (in ms)</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "user_agent",
            "description": "<p>The user agent sent with the request</p>"
          }
        ]
      }
    },
